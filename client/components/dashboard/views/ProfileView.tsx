      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12 px-2">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="p-6 rounded-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
              ...
              {socialLinks.map((link) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <span className="text-smaller text-slate-600 dark:text-slate-400 group-hover:text-slate-900 dark:group-hover:text-white">
                      {link.name}
                    </span>
                  </div>
        ...
        <div className="lg:col-span-2 space-y-8">
          {/* Bio Section */}
          <section className="p-8 rounded-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm min-h-64">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {createdProjects.map((project) => (
                      <Link
                        ...
                        className="group flex gap-4 p-4 rounded-5 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:border-primary/30 transition-all hover:shadow-md"
                      >
                        <div className="size-16 rounded-xl overflow-hidden bg-slate-100 dark:bg-slate-800 shrink-0">
                          <img
                            src={
                              project.thumbnailUrl ||
                              `https://ui-avatars.com/api/?name=${encodeURIComponent(project.title)}&background=random`
                            }
                            alt={project.title}
