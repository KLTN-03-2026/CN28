          ...
          <div className="flex items-center gap-3 md:gap-4 shrink-0 order-2 ml-auto md:ml-0 md:order-3">
            {isInitializing ? (
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="size-8 rounded-full bg-slate-200 dark:bg-slate-800 animate-pulse shrink-0"></div>
                      ...
                      <div className="px-4 py-2 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-white dark:bg-slate-900 sticky top-0 z-10">
                        ...
                        {unreadCount > 0 && (
                          <button
                            ...
                            className="text-primary text-smallest hover:underline"
                          >
                ...
                <div className="relative">
                  ...
                  >
                    {user.avatarUrl ? (
                      ...
                      <div className="size-8 rounded-full bg-primary flex items-center justify-center text-white text-smallest font-bold shrink-0">
