...
const MDEditorWithNoSSR = dynamic(() => import("@uiw/react-md-editor"), {
  ssr: false,
  loading: () => (
...
export default function MarkdownField({
  ...
  const imageCommand = {
    ...
    icon: (
      <svg width="12" height="12" viewBox="0 0 20 20">
        <path
          fill="currentColor"
          d="M15 9c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm4-7H1C.5 2 0 2.5 0 3v14c0 .5.5 1 1 1h18c.5 0 1-.5 1-1V3c0-.5-.5-1-1-1zM3 16l4-5 3.5 4.5 3-4L17 16H3z"
        />
      </svg>
    ),
  ...
  return (
    <div className="md-editor-container space-y-2">
      {label && (
        <label className="block text-smaller font-semibold mb-2">{label}</label>
      )}
